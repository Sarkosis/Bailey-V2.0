              ...
              await client.con.query(
                ...
                async (e, rows) => {
                  ...
                  let a = new ActionRowBuilder().addComponents(
                    ...
                    new ButtonBuilder()
                      .setCustomId("close-ticket-drp")
                      .setStyle(ButtonStyle.Danger)
                      .setLabel("Close"),
                    new ButtonBuilder()
                      .setCustomId("lock-ticket-drp")
                      .setStyle(ButtonStyle.Danger)
                      .setEmoji("🔒")
                      .setLabel("Lock"),
                    new ButtonBuilder()
                      .setCustomId("unlock-ticket-drp")
                  ...
                  let b = new ActionRowBuilder().addComponents(
                    ...
                    new ButtonBuilder()
                      .setCustomId("archive-ticket-drp")
                      .setStyle(ButtonStyle.Danger)
                      .setEmoji("🗃️")
                      .setLabel("Archive"),
                    new ButtonBuilder()
                      .setCustomId("unarchive-ticket-drp")
                  ...
                  let c = new ActionRowBuilder().addComponents(
                    ...
                    new ButtonBuilder()
                      .setCustomId("claim-ticket-drp")
                      .setStyle(ButtonStyle.Success)
                      .setEmoji("👋")
                      .setLabel("Claim"),
                    new ButtonBuilder()
                      .setCustomId("unclaim-ticket-drp")
                      .setStyle(ButtonStyle.Danger)
                      .setEmoji("💨")
                      .setLabel("Unclaim"),
                    new ButtonBuilder()
                      .setCustomId("trnclm-ticket-drp")
                      .setStyle(ButtonStyle.Primary)
                      .setEmoji("🤝")
                  ...
                  let f = new ActionRowBuilder().addComponents(
                    ...
                    new ButtonBuilder()
                      .setCustomId("htmltran-ticket-drp")
                      .setStyle(ButtonStyle.Primary)
                      .setEmoji("📂")
              ...
              await client.con.query(
                ...
                async (e, rows) => {
                  ...
                  let bt = new ActionRowBuilder().addComponents(
                    ...
                    new ButtonBuilder()
                      .setCustomId("adduser-ticket-drp")
                      .setStyle(ButtonStyle.Success)
                      .setLabel("Add user"),
                    new ButtonBuilder()
                      .setCustomId("removeuser-ticket-drp")
                      .setStyle(ButtonStyle.Danger)
              ...
              await client.con.query(
                ...
                async (e, rows) => {
                  ...
                  let d = new ActionRowBuilder().addComponents(
                    ...
                    new ButtonBuilder()
                      .setCustomId("addrole-ticket-drp")
                      .setStyle(ButtonStyle.Success)
                      .setLabel("Add role"),
                    new ButtonBuilder()
                      .setCustomId("removerole-ticket-drp")
                      .setStyle(ButtonStyle.Danger)
                        ...
                        async (e) => {
                          ...
                          await client.con.query(
                            ...
                            async (e, row) => {
                              ...
                              if (row[0]) {
                                await client.con.query(
                                  `SELECT * FROM drproles WHERE GuildID = '${guild.id}' AND PanelID = '${row[0]?.PanelID}'`,
                                  async (e, rows) => {
                                    if (e) {
                                      if (client.config.debugmode) {
                                        console.log(e.stack);
      ...
      case "unarchive-ticket-drp":
        {
          await client.con.query(
            ...
            async (e, row) => {
              ...
              await client.con.query(
                `SELECT * FROM drppanels WHERE GuildID = "${guild.id}" AND PanelID = "${row[0]?.PanelID}"`,
                async (e, p) => {
                  if (e) {
                    if (client.config.debugmode) {
                      console.log(e.stack);
                  ...
                  await client.con.query(
                    ...
                    async (e, rows) => {
                      ...
                      let btns = new ActionRowBuilder().addComponents(
                        new ButtonBuilder()
                          .setCustomId("accept-claim-drp")
                          .setStyle(ButtonStyle.Success)
                          .setLabel("Accept"),
                        new ButtonBuilder()
                          .setCustomId("deny-claim-drp")
                          .setStyle(ButtonStyle.Danger)
                          .setLabel("Deny")
                      );
                      let embed = new EmbedBuilder()
